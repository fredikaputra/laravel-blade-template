...
covers(UpdateUserProfileInformation::class, AppServiceProvider::class, FortifyServiceProvider::class, User::class);
...
it('validates invalid profile payloads', function (array $overrides): void {
    ...
    App::make(UpdateUserProfileInformation::class)->update($user, $input);
})->with([
...
it('updates a user profile without changing the email address', function (): void {
    ...
    expect($user->getRawOriginal('email'))->toBeString();
